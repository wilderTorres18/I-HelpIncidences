        ...
        <div class="md:flex justify-center">
          <div class="md:w-full">
            ...
            <div class="mt-2 p-6 bg-white rounded-md leading-7">
              <span class="bg-primary border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90 cursor-pointer" @click="print('printArea')">Print</span>
            </div>
          </div><!--end -->
        </div><!--end grid-->
      </div><!--end container-->
