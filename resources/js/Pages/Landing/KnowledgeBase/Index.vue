          ...
          <div class="flex justify-center w-full">
            <form class="w-full lg:w-1/3">
              ...
              <div class="relative">
                ...
                <input id="default-search" v-model="form.search" type="search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search in knowledge base..." required />
              </div>
            </form>
          </div>
        </div>
        <div v-if="kb.data.length" class="-mx-4 flex flex-wrap">
          <div v-for="knowledge in kb.data" :key="knowledge.id" class="w-full px-4 md:w-1/2 lg:w-1/3">
