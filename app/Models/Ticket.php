...
class Ticket extends Model
{
    ...
    public function scopeOrderBySubject($query): void
    {
    ...
    public function getDueAttribute($date): string
    {
        return Carbon::parse($date)->format('Y-m-d');
    }

    public function scopeByCustomer($query, $id): void
    {
        if(!empty($id)){
    ...
    public function scopeByUser($query, $id): void
    {
        if(!empty($id)){
            $query->where('user_id', $id);
        }
    ...
    public function scopeByAssign($query, $id): void
    {
        if(!empty($id)){
