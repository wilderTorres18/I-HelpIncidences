<template>
  <div>
    ...
    <section class="pt-20 pb-10 lg:pt-[120px] lg:pb-20 bg-gray-50">
      <div class="container">
        <form class="card mt-2 p-4 rounded shadow-xl overflow-hidden" enctype="multipart/form-data" @submit.prevent="store">
          <div class="px-5 pt-8">
            <div class="flex flex-wrap">
              ...
              <div class=" pt-2 pb-8 w-full">
                ...
                <ckeditor id="ticketDetails" v-model="form.details" :editor="editor" :error="form.errors.details" :config="editorConfig" />
              </div>
            </div>
            ...
            <div class="pr-6 pb-8 w-full lg:w-full flex-col">
              ...
              <div v-for="(file, fi) in form.files" v-if="form.files.length" :key="fi" class="flex items-center justify-between pr-6 pt-8 w-full lg:w-1/2">
