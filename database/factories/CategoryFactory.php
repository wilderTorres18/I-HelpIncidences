...
class CategoryFactory extends Factory
{
    ...
    {
        return [
            'name' => $this->faker->unique()->randomElement(['Interfaz de usuario', 'Conexión a Base de datos', 'Cálculos', 'Reportes y documentos', 'Gestión de usuarios y permisos', 'Procesamiento de Pagos', 'Notificaciones y Alertas', 'Compatibilidad','Instalación y configuración','Otros']),
