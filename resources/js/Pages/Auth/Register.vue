      ...
      >
        <div class="px-10 py-12">
          ...
          <div class="flex flex-wrap -mb-8 -mr-6 p-3">
            ...
            />
            <text-input
              v-model="form.confirm_password" :error="form.errors.confirm_password"
